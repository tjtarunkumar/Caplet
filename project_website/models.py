...
class ChildCategories(models.Model):
    ...
    slug = models.CharField(unique=True, max_length=100)
    description = models.TextField()
    child_image = models.CharField(max_length=100)
    created = models.DateTimeField()
    updated = models.DateTimeField()
    category_name = models.ForeignKey(Categories, models.DO_NOTHING)
    subcategory_name = models.ForeignKey('SubCategories', models.DO_NOTHING)
